"""Argentina vs Switzerland (cuartos de final / Quarterfinal, 2026-07-11) — config; lógica en el engine. AS_OF sin fuga."""
import sys
...
HOME, AWAY, NEUTRAL = "Argentina", "Switzerland", True
AS_OF = "2026-07-11"
