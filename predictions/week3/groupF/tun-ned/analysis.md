...
- Model: **Tunisia 8%** · Draw 18% · **Netherlands 74%**

| sel | model | sharp fair | best | verdict |
|---|---|---|---|---|
| home | 8% | 3% | 30.03 | **pass** |
| draw | 18% | 9% | 12.00 | **pass** |
| away | 74% | 88% | 1.14 | **pass** |

## Goals (total)

- Expected goals: Tunisia 0.69 – 1.99 Netherlands  (total λ 2.68)
